                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 p-t-20">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                大寒
                                <img src="src/assets/village/snowflake.png" alt="snowflake" class="pull-right" width="20px">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
  ...
  export default {
    ...
    data () {
      return {
        'step': {
          'video': 'ubGoh0krjQQ',
          'intro': '一溝淹滿再換另一溝淹，避免水集中在出水口前頭 導致前端土壤過度濕潤，而水也無法抵達田區後方'
        }
      }
    }
  }
...
<style scoped>
    .village {
        background-image: url('/src/assets/village/normal-bg.png');
    }
</style>
